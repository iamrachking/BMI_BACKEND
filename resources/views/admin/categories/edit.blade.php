            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                    ...
                    @if($category->imageUrl())
                        <img src="{{ $category->imageUrl() }}" alt="{{ $category->name }}" class="w-full rounded-lg object-cover aspect-square border border-gray-200 mb-3">
                    @endif
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" placeholder="Nom de la catégorie" required class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" placeholder="Description de la catégorie…" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">{{ old('description', $category->description) }}</textarea>
